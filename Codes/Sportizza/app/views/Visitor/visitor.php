...
<head>
  ...
  <link rel="stylesheet" href="/Sportizza/public/css/visitor.css" />
            ...
            <div class="column-2">
              <div class="search-wrap">
                <div class="search-box">
                  ...
                  <a href="#search-results-id" class="btn search-btn" onclick=showHiddenContent()>Search</a>
        ...
        <div class="contact-box">
          ...
          <div class="contact-form">
            ...
            <div class="row">
              ...
              <input type="text" class="contact-input" id="firstName" name="firstName" placeholder="First Name" /> </div>
              <div class="form-group">
                <label for="lastName"> </label>
                <input type="text" class="contact-input" id="lastName" name="lastName" placeholder="Last Name" /> </div>
            </div>

            <div class="row">
              <div class="form-group">
                <label for="phone"> </label>
                <input type="text" class="contact-input" id="phone" name="phone" placeholder="Phone" /> </div>
              <div class="form-group">
                <label for="email"> </label>
                <input type="text" class="contact-input" id="email" name="email" placeholder="Email" /> </div>
