...
class NotificationModel extends \Core\Model
{
    ...
    public static function customerBookingCancellationDeleteTimeslotNotification($timeslot_id)
    {
        ...
        WHERE `booking_timeslot`.`timeslot_id` = :timeslot_id ";
            ...
            if ($payment_method == 'cash' && $payment_status == 'unpaid') {
                // Initialize descriptions
                $custdesc = " " . $saname . " had cancelled your booking your booking " . $booking_id . " made for " . $facname . " on " . $bdate . " scheduled from " . $stime . " to " . $etime . " as this timeslot is no longer available.";
            } else {
                // Initialize descriptions
                $custdesc = " " . $saname . " had cancelled your booking your booking " . $booking_id . " made for " . $facname . " on " . $bdate . " scheduled from " . $stime . " to " . $etime . " as this timeslot is no longer available. Please apply for refund form to collect your refund. Note that we'll be making a bank transfer.";
            }
